...
def semantic_lidar_data(point_cloud, lidar_point_cloud_buffer):
    ...
    matrix_rephttps://lh7-us.googleusercontent.com/dcmGmfRXcaISIiPF3rj1HZ38VqPAODd4UYCXJ3Sn_OFqoLTVRm9N_5Fn2_7pzSlOYxtY4B7lALc_0gUMu6QGeNUwhlHrbLDdbfrD_houIGTz12v8o6FSmZkMP16ZZdm8jLyCJhlTo_zPqVf2vvqsJQresentational_data = np.frombuffer(point_cloud.raw_data, dtype=np.dtype([
